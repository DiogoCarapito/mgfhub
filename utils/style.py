...
def card_container(title, text, image, link, em_construcao):
    ...
    with st.container():
        st.markdown(
            f'<div style="text-align: center; border: 0px solid #ddd; border-radius: 10px; padding: 10px 20px 10px 20px; background: linear-gradient(135deg, rgba(88, 142, 249, 0.05), rgba(190, 28, 243, 0.05));">'
