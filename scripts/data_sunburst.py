...
df_todos_indicadores = pd.read_csv(
    pythonanywhere_file_tree + "data/scrapped_indicadores.csv"
)
usf_ucsp_para_idg = pd.read_csv(
    pythonanywhere_file_tree + "data/usf_ucsp_indicadores_2022_comimpactoIDG.csv"
)
