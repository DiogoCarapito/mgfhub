                    ...
                    dbc.Row([
                        dbc.Col([
                            ...
                            dbc.Row([
                                ...
                                html.A(indicador[1]['link'], href=indicador[1]['link']),
                            ]),
...
contagem = html.Div([html.P(id='searchbox_indicadores_tabela')],style={'padding': '12px 0px 0px 4px'})
...
def table_update(searchbox,radio_tabela):
    ...
    df_columns = [{'id': x, 'name': x, 'presentation': 'markdown'} if x == 'id' else {'id': x, 'name': x} for x in df_after_search_tabela.columns]
